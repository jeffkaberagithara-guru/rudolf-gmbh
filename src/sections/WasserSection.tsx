...
export default function WasserSection() {
  ...
  return (
    <section
      ...
      aria-label="Water Installations"
    >
      <motion.div
      ...
      >
        <video
          ...
          playsInline
          preload="none"
          poster={MEDIA.posters.water}
        >
          <source src={MEDIA.videos.water} type="video/mp4" />
        </video>
      </motion.div>
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-10 lg:px-16 max-w-[1400px] mx-auto">
        <motion.div style={{ y: prefersReducedMotion ? 0 : textY }} className="max-w-2xl">
          ...
          >
            WATER<span className="block text-accent-light">INSTALLATIONS.</span>
          </motion.h2>
          ...
          >
            From complete water installations to sanitary renovations — we
            build reliable water systems that function flawlessly for years.
            Clean, precise, built to last.
          </motion.p>
