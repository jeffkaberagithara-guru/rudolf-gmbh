    ...
    >
      ...
      >
        <video
          ...
          preload="none"
        >
          <source src={MEDIA.videos.gas} type="video/mp4" />
        </video>
      </motion.div>
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-10 lg:px-16 max-w-[1400px] mx-auto">
        <motion.div style={{ y: prefersReducedMotion ? 0 : textY }} className="max-w-2xl">
          ...
          >
            GAS<span className="block text-accent-light">INSTALLATIONS.</span>
          </motion.h2>
          ...
          >
            Safety starts with precision. We install, maintain, and inspect
            your gas systems with the utmost care — for your protection and
            the optimal operation of your gas appliances.
          </motion.p>
